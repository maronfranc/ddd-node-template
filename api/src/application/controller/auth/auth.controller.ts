...
import { ILoginDto, validateLoginDto } from './dto/login.dto';
import { IRegisterUserDto, validateRegisterUserDto } from './dto/register-user.dto';
...
export class AuthController {
  ...
  public async register(@Body() body: IRegisterUserDto) {
    ...
    if (dtoError) throw new DomainException(dtoError);
